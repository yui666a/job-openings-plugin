      ...
      <table style="border-collapse: collapse" border-color="EEE">
        <tr>
          ...
          <td class="assignment-table-contents">
            <pre>(TODO: 職種の情報を表示)</pre>
          </td>
        </tr>
        <tr>
          <th class="assignment-table-items">雇用形態</th>
          <td class="assignment-table-contents">
            <pre>(TODO: 雇用形態の情報を表示)</pre>
          </td>
        </tr>
        <tr>
    ...
    <div class="side-box">
      <div class="google-map">
        <div class="google-map-box">
          ...
          <a href="#" class="google-map-address"
            >(TODO: 勤務地の所在地に関する情報を表示)</a
          >
