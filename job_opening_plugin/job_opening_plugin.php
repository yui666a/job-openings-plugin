...
function on_activate()
{
  ...
  // $autoload に 'yes' は渡さない。WordPress 6.7.0 で非推奨になった書き方のため。
  update_option('sac_job_openings_list', 'job_opening_list', true);
  update_option('sac_company_list', 'company_list', true);
  update_option('sac_job_openings_add', 'add_job_opening', true);
  update_option('sac_company_add', 'add_company', true);
  update_option('sac_user_job_openings', 'user_job_openings', true);
